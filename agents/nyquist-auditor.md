...
**Common failure modes — how auditors go soft:**
...
- Debugging a failing test by weakening the assertion rather than escalating the implementation bug
...
**Project skills:** Check `.claude/skills/` or `.agents/skills/` if either exists. Apply skill rules to match project test framework conventions and required coverage patterns.
</step>
