...
description: Use when building a healthcare product that must comply with HIPAA — determining Business Associate status, handling PHI, implementing Security Rule safeguards, or preparing BAAs and breach response plans. Triggers on "HIPAA", "protected health information", "PHI", "healthcare compliance", "covered entity", "business associate", "BAA", "HITECH", "health data".
license: MIT
metadata:
  version: "1.0.0"
  domain: healthcare-compliance
  triggers: HIPAA, PHI, ePHI, protected health information, covered entity, business associate, BAA, HITECH, healthcare compliance, breach notification
  role: specialist
  scope: audit
...
HIPAA compliance methodology for healthcare technology products. Understand obligations under HIPAA, identify Business Associate status, implement required safeguards, and close compliance gaps before they create liability.
...
### Business Associates (The likely category for a SaaS vendor)
...
**A vendor is a Business Associate if** a healthcare provider uses its product and PHI is stored in or transmitted through the system.

## Business Associate Agreement (BAA)

A BAA is a legally required contract between the Covered Entity and Business Associate.
- PHI CANNOT legally be handled without a signed BAA
...
1. Determine if the vendor is a Business Associate
