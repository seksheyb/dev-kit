 ...
 *   routing    object    optional  { "plan-reviewer": {model?, effort?} }, decided
 ...
 * `args.routing` data — this script performs no judgment of its own about which model or
 * effort a lens dispatch should run at.
 *
