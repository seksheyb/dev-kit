...
|---|---|---|---|
| Product / Requirements Owner | Turning an idea into a validated, unambiguous spec | [core-discovery-and-design.md](core-discovery-and-design.md#role-product--requirements-owner) | 19 |
...
**97 items** — 52 skills, 37 agents, 8 commands.
