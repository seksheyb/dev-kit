...
**Population:** Frontmatter is populated during summary creation by the executing skill/agent. See the `sprint-execution` skill's summary-creation step for field-by-field guidance.
</frontmatter_guidance>
