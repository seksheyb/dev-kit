...
`references/dx-calibration.md` holds gold-standard examples, anti-patterns, and stats used to
calibrate each pass's score against a real-world bar (what a 9-10 actually looks like,
concretely). Read ONLY the section for the pass you're currently scoring (e.g. "Pass 1" while
running Pass 1) — don't load the whole file at once.
