---
name: growth-loops
description: Use when designing a growth loop, understanding product-led growth (PLG) mechanics, or building sustainable compounding acquisition. Invoke for viral/content/paid/network-effect loop design, constraint analysis, and loop metrics. Triggers on "growth loop", "flywheel", "viral loop", "PLG growth", "product-led growth", "growth mechanics", "how do we grow", "word of mouth".
license: MIT
metadata:
  version: "1.0.0"
  domain: product-growth
  triggers: growth loop, flywheel, viral loop, PLG, product-led growth, viral coefficient, network effects, acquisition loop
  role: strategist
  scope: design
...
Self-reinforcing growth loop design methodology. Move beyond linear ad spend toward compounding, durable acquisition mechanics where product usage generates more users.
...
**Viral coefficient (K)**: number of new users each existing user generates.
