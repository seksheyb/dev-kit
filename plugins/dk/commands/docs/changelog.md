...
anything above patch. Then tell me plainly that ship's coverage-gap tracing and plan-completion
audit did not run on this path either.

→ next: `/dk:docs:release`
