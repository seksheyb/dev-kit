...
```
Workflow({ scriptPath: "<dev-kit-core>/references/workflows/discovery-research.workflow.mjs", args: {   // real fs path: run the bare command dev-kit-core-root and substitute its output for <dev-kit-core>
