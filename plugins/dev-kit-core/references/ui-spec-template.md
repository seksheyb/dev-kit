...
Template for `docs/milestones/<M>/phases/<NN>-<slug>/UI-SPEC.md`.
...
# Phase <NN> — UI Design Contract

> Visual and interaction contract for frontend phases. Generated by ui-researcher, verified by ui-checker.
